...
export default function D3ex1() {
    ...
    return (
        <Jumbotron className='fullpage'>
            <h1 className='text-gold'>D3 Ex. 1</h1>
            ...
            <Row>
                ...
                <Col xs={6} md={8}>
                    <main>
                        <h2>Using D3.js Inside a React App</h2>
                        <p className="mb-4">
                            <a
                                target='_blank'
                                rel='noopener noreferrer'
                                href='https://www.pluralsight.com/guides/using-d3.js-inside-a-react-app'>
